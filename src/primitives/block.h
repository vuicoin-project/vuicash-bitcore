...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // vuicash
        hashUTXORoot.SetNull(); // vuicash
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //vuicash
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //vuicash
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //vuicash
    {
